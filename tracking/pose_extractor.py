...
for video_name in video_list:
    ...
    try:
        ...
        for i in range(
            1,
            len(right_hand_positions)
        ):

            x1, y1 = (
                right_hand_positions[i - 1]
            )

            x2, y2 = (
                right_hand_positions[i]
            )
...
print()
print("=" * 50)
print("pose_features(100).csv 저장 완료")
